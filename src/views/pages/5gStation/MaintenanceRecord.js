...
import { SearchMaintenanceLogAPI } from "src/webAPI/5GStationAPI";
    ...
    <div>
      <CRow className="justify-content-center">
        <CCard className="mx-3" style={{ width: '65rem' }}>
          <CCardHeader>{t('5gmaintaintitle-5gmaintenance')}</CCardHeader>
